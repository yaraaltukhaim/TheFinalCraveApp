...
struct  Khaleeji_Previews: PreviewProvider {
    static var previews: some View {
        Khaleeji()
    }
}

struct KhaleejiName : View {
    @State var restaurant = [
        ...
        Tools(id: 0, image: "Al Romansiah", name: "Al Romansiah", offset: 0, place: 1),
           ...
           Tools(id: 3, image: "Aseeb", name: "Aseeb Najd", offset: 0, place: 4),
    ...
    var body: some View {
        ZStack {
            ...
            if show {
                KhaleejiDetail(tool: selected, show: $show, name: name)
            }
        }
        .background(
...
struct KhaleejiTools: Identifiable {
    var id: Int
    var image: String
    var name: String
    var offset: CGFloat
