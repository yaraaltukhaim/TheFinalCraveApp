...
struct  Italian_Previews: PreviewProvider {
    static var previews: some View {
        Italian()
    }
}

struct ItalianName : View {
    @State var restaurant = [
        
            Tools(id: 0, image: "Pizza Hut", name: "Pizza Hut", offset: 0, place: 1),
                   Tools(id: 1, image: "Dominos", name: "Dominos pizza", offset: 0, place: 2),
    ...
    var body: some View {
        ZStack {
            ...
            if show {
                ItalianDetail(tool: selected, show: $show, name: name)
            }
        }
        .background(
...
struct ItalianTools: Identifiable {
    var id: Int
    var image: String
    var name: String
    var offset: CGFloat
