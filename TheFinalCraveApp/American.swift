...
struct AmericanName : View {
    @State var restaurant = [
            ...
            Tools(id: 0, image: "Mcdonalds", name: "McDonalds", offset: 0, place: 1),
                   ...
                   Tools(id: 7, image: "SteakHouse", name: "Steak House", offset: 0, place: 8),
    ...
    var body: some View {
        ZStack {
            ...
            if show {
                AmericanDetail(tool: selected, show: $show, name: name)
            }
        }
        .background(
...
struct AmericanTools: Identifiable {
    var id: Int
    var image: String
    var name: String
    var offset: CGFloat
