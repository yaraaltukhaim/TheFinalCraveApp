...
struct Asian_Previews: PreviewProvider {
    static var previews: some View {
        Asian()
    }
}

struct AsianName: View {
    @State var restaurant = [
        ...
        Tools(id: 7, image: "MasamiSushi", name: "Masami Sushi", offset: 0, place: 8),
    ...
    var body: some View {
        ZStack {
            ...
            if show {
                AsianDetail(tool: selected, show: $show, name: name)
            }
        }
        .background(
...
struct AsianTools: Identifiable {
    var id: Int
    var image: String
    var name: String
    var offset: CGFloat
